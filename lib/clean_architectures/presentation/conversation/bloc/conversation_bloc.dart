...
import 'package:chat_bot_package/clean_architectures/domain/usecase/conversation_usecase.dart';
import 'package:chat_bot_package/clean_architectures/presentation/conversation/bloc/conversation_modal_state.dart';
  ...
  FutureOr<void> _onSelectConversation(
    ...
    return emit(
      _SelectConversationSuccess(
          data: data.copyWith(currentConversationId: event.conversationId),
