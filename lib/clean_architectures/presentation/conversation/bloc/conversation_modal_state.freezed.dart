...
class _$ConversationViewStateImpl implements _ConversationViewState {
  ...
  @override
  String toString() {
    return 'ConversationModalState(conversations: $conversations, selectedConversations: $selectedConversations, currentConversationId: $currentConversationId)';
  }
...
abstract class _ConversationViewState implements ConversationModalState {
  const factory _ConversationViewState(
      ...
      final int? currentConversationId}) = _$ConversationViewStateImpl;
